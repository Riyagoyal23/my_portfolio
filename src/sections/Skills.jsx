...
' />
      ...
      >
Java | MERN Stack | Data Structures & Algorithms | Building Scalable Applications with Modern Technologies
      </motion.p>
...
<div className="mt-12 flex flex-col items-center z-10">
  ...
  <div className="flex flex-wrap justify-center gap-4 max-w-4xl">
    {[
      ...
      <div
        key={index}
        className="px-5 py-3 rounded-full border border-[#1cd8d2]/30 bg-white/5 text-white hover:bg-[#1cd8d2]/10 transition"
      >
        {subject}
      </div>
    ))}
