...
/>
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            ...
            <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
              ...
              Data Structures & Algorithms, and Full Stack Development. I enjoy building real-world projects using Java, React, Node.js, and databases while continuously improving my problem-solving skills.
            </p>
            <div className="mt-6">
  ...
  { label: "Tech Stack", value: "Java | MERN" },
  { label: "Core Skills", value: "DSA & OOPs" },
].map((item, i) => (
                <motion.div
                  key={i}
        ...
        <div className="grid md:grid-cols-1">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
             I am passionate about creating efficient software solutions and learning new technologies. My interests include Java development, web technologies, database systems, and competitive programming.
            </p>
            <p className="mt-4 text-gray-400 text-base sm:text-lg">
              My goal is to contribute to innovative software projects, gain industry experience, and grow into a skilled Software Engineer. 
            </p>
          </motion.div>
        </div>
      </div>
