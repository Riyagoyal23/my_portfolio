...
const experiences = [
  ...
  duration: "Present",
  description:
    "Actively seeking Software Development Internship opportunities while continuously improving problem-solving skills through Data Structures & Algorithms and building scalable full-stack applications.",
},,
  ...
  description:
    "Developed full-stack web applications using the MERN Stack, including a Personal Expense Tracker and an E-commerce Website featuring authentication, REST APIs, and MongoDB integration.",
},,

  {
    ...
    description:
      "Built Java applications including a Library Management System using Java and MySQL while gaining hands-on experience in OOPs, DBMS, Operating Systems, and Computer Networks.",
  },
];
      ...
      <div ref={sceneRef} style={{ height: `${SCENE_HEIGHT_VH}vh`, minHeight: "120vh" }} className="relative">
        <div className="sticky top-0 h-screen flex flex-col">
          ...
          <div className="shrink-0 px-6 pt-8">
            <h2 className="text-4xl sm:text-5xl font-bold mt-5 text-center bg-gradient-to-r from-[#1CD8D2] via-[#00bf8f] to-[#302b63] bg-clip-text text-transparent">
  Experience
</h2>
          </div>
          {/* Timeline container */}
